...
namespace APIVerve.API.SWIFTCodeLookup
{
    ...
    /// <summary>
    /// Client for the SWIFTCodeLookup API
    /// </summary>
    public class SWIFTCodeLookupAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/swiftlookup";
        ...
        {
            { "swift", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public SWIFTCodeLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SWIFTCodeLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SWIFTCodeLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SWIFTCodeLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SWIFTCodeLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(SWIFTCodeLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SWIFTCodeLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SWIFTCodeLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SWIFTCodeLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SWIFTCodeLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SWIFTCodeLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SWIFTCodeLookupQueryOptions options)
        {

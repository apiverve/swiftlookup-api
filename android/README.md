...
```gradle
dependencies {
    implementation 'com.github.apiverve:swiftlookup-api:1.1.13'
}
```
...
```java
import com.apiverve.swiftlookup.SWIFTCodeLookupAPIClient;
import com.apiverve.swiftlookup.APIResponse;
import com.apiverve.swiftlookup.APIException;

// Initialize the client
SWIFTCodeLookupAPIClient client = new SWIFTCodeLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("swift", "CHASUS33ARP");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/swiftlookup](https://docs.apiverve.com/ref/swiftlookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/swiftlookup](https://docs.apiverve.com/ref/swiftlookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/swiftlookup-api/issues)

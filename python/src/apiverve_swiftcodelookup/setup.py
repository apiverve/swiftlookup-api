...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/swiftlookup',
        'Source': 'https://github.com/apiverve/swiftlookup-api',
        'Bug Tracker': 'https://github.com/apiverve/swiftlookup-api/issues'
    },
    classifiers=[

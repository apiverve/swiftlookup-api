// Package swiftlookup provides a Go client for the SWIFT Code Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/swiftlookup?utm_source=go&utm_medium=readme
package swiftlookup
...
// Request contains the parameters for the SWIFT Code Lookup API.
//
// Parameters:
//   - swift (required): string - The SWIFT code to lookup information about
type Request struct {
	Swift string `json:"swift"` // Required
}
...
// ResponseData contains the data returned by the SWIFT Code Lookup API.
type ResponseData struct {
	Count int `json:"count"`
	Banks []BanksItem `json:"banks"`
}

// BanksItem represents an item in the Banks array.
type BanksItem struct {

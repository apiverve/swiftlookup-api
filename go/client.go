...
const (
	baseURL        = "https://api.apiverve.com/v1/swiftlookup"
	defaultTimeout = 30 * time.Second
)

// Client is the SWIFT Code Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new SWIFT Code Lookup API client.
...
// Execute makes a request to the SWIFT Code Lookup API with typed parameters.
//
